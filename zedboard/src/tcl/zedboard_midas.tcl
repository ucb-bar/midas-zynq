...
#
# zedboard_midas.tcl: Tcl script for re-creating project 'zedboard_midas'
#
...
set orig_proj_dir "[file normalize "$origin_dir/zedboard_midas"]"

# Create project
create_project zedboard_midas $orig_proj_dir

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects zedboard_midas]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/verilog/ZynqShim.v"]"\
...
puts "INFO: Project created:zedboard_midas"
