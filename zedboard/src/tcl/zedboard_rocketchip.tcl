...
#
# zedboard_rocketchip.tcl: Tcl script for re-creating project 'zedboard_rocketchip'
#
...
set orig_proj_dir "[file normalize "$origin_dir/zedboard_rocketchip"]"

# Create project
create_project zedboard_rocketchip $orig_proj_dir

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects zedboard_rocketchip]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/verilog/TileNastiShim.v"]"\
...
puts "INFO: Project created:zedboard_rocketchip"

puts "INFO: Recreating block diagram from src/tcl/zedboard_bd.tcl"
source src/tcl/zedboard_bd.tcl
